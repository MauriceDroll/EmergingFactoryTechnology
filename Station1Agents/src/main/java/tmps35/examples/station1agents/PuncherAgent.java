...
import com.mcl.automationlab.libraries.highlevel.station1.Puncher;
 ...
 * @author luiri60
 */
public class PuncherAgent extends Agent {
    ...
    protected void setup() {
        ...
        puncher = system.getPuncher();
        addBehaviour(tbf.wrap(new ProcessExecutionRequestPuncher(this, MessageTemplate.MatchPerformative(ACLMessage.REQUEST))));
        addBehaviour(tbf.wrap(new ProcessExecutionRequestPuncher(this, MessageTemplate.MatchPerformative(ACLMessage.REQUEST))));                
